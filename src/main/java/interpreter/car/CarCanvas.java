...
public class CarCanvas extends Canvas implements ExecutorFactory {
...
abstract class CarExecutor implements Executor {
    protected CarCanvas canvas;
    public CarExecutor(CarCanvas canvas) {
        this.canvas = canvas;
    }
    public abstract void execute();
}
class GoExecutor extends CarExecutor {
    public GoExecutor(CarCanvas carCanvas) {
        super(carCanvas);
    }

    @Override
    public void execute() {
        canvas.go(CarCanvas.UNIT_LENGTH);
    }
}

class DirectionExecutor extends CarExecutor {
    private int relativeDirection;
    public DirectionExecutor(CarCanvas carCanvas, int relativeDirection) {
        super(carCanvas);
